...
object DateTimeUtils {
    ...
    val DATE_FORMAT_FULL_YEAR_DASHED: DateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd")
    ...
    fun LocalDate.dayOfWeek(): String = format(DateTimeFormatter.ofPattern("E", Locale.KOREAN))
